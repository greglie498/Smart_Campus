...
export const locations: Location[] = [
  {
    ...
    accessibility:
      "Step-free access, accessible study spaces, and assistance available at the service desk.",
    details:
      "Borrowing, reference, research support, and group study services are available.",
    features: [
  ...
  },
  {
    ...
    accessibility:
      "Accessible entrances, seating, and circulation routes are available for guests and event attendees.",
    details:
      "Event coordination, presentation facilities, and audience seating support a range of campus programmes.",
    features: [
      "Event and conference space",
      "Performance and presentation facilities",
      "Audience seating",
  ...
  },
  {
    ...
    accessibility:
      "Accessible routes and support are available for visitors who need assistance navigating the facility.",
    details:
      "The building hosts multipurpose spaces, organised programmes, and services for students, staff, and visitors.",
    features: [
      "Multipurpose rooms",
  ...
  },
  {
    ...
    accessibility:
      "Accessible routes and facilities are available, with assistance provided through the campus information desk.",
    details:
      "Use of courts, fitness areas, and organised activities may require scheduling or programme registration.",
    features: [
